...
原创桌面网页 3D 海上生存游戏。当前版本为 `0.14.8` 高质量纵向切片，不以基础 Demo 为完成标准。
...
当前仍不是完整游戏。整套建造流程的无说明玩家验收、鲨鱼战利品、更多深水生态资源、潜水装备、天气农业、大型信号目的地、无说明玩家平衡验收和最终蒙皮资产仍按 [项目追踪](PROJECT_TRACKER.md) 继续开发。
