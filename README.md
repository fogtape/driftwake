...
原创桌面网页 3D 海上生存游戏。当前版本为 `0.11.0` 高质量纵向切片，不以基础 Demo 为完成标准。
...
- v10 版本化自动存档，保存三表面导航、持续世界坐标、信号原点/发现/访问、电池状态、岛礁节点、逐格筏体、高级生活设备、天气、航线及帆锚强化状态，并迁移 v1-v9；
- 六总线程序音频混音，以及水下低通、五联净水装填、三槽食物位、干舱开合/转移、接收台底噪/开关/调谐/扫描脉冲/抵达和阵列诊断、玻璃凝固、锚具强化与滑脱、帆布受风/过载、风雨雷声、种植、研究、礁区和生物声音；
...
当前仍不是完整游戏。更多深水生态资源、潜水装备、天气农业、死亡恢复、工具耐久、大型信号目的地和最终蒙皮资产仍按 [项目追踪](PROJECT_TRACKER.md) 继续开发。
