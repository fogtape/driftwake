...
- 原创代码原生双手装配：40+ 分层网格、盐封帆布手套、独立腕部/双段手指关节、左右抓握挂点，以及待机、蓄力、放绳、受力和回收姿态；
...
- 生产构建通过：CSS 64.40 kB、主入口 302.07 kB、3D chunk 886.68 kB、Rapier 2,237.42 kB；
...
- 钩具装备期间双手始终存在，蓄力、放绳、命中受力和回收姿态连续；飞行钩使用独立投射模型，不得复制手部；
