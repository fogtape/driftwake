...
> 当前状态：`DOING`（大型信号目的地、持续海图、目的地音频与本轮材质已完成；研究/熔炼成长节奏和真实 GPU 发布门禁继续保留）
> 本次切片：三座原创远海目的地、航海图、目标选择、近场音频与 M8 专用 PBR
> 版本：`0.19.0`
> 日期：2026-07-22
...
M8 仍保持 `DOING`：研究项目数量、进阶资源分布和 30-60 分钟前期成长节奏需要无说明玩家再平衡；最终 DCC 蒙皮、多样本录音、多存档位/备份、真 Context Lost/Restore 与目标 GPU 发布验证转入 M9。
