...
- 首轮 11 件漂流带按真实战利品与配方验证可在约第 3 分钟完成绳、杯和净水器；依赖产物必须等待绳索 0.9 秒完成，不允许提前透支；
- 3600 秒平衡合同复用真实生存衰减、制作队列、设备循环和消费逻辑：第 10 分钟继续取得一只补给箱时可完成四轮净水，末值生命 100、水分大于 45、饱食大于 42；完全不行动在约 35–36 分钟失败；
